...
class SentinelSceneReview(Base):
    __tablename__ = "forest_sentinel_scene_reviews"
    __table_args__ = (
        UniqueConstraint("download_id", name="uq_forest_sentinel_scene_reviews_download_id"),
    )
